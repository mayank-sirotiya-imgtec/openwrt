...
define KernelPackage/sound-pistachio-soc
  ...
  AUTOLOAD:=$(call AutoProbe,img-i2s-in.ko img-i2s-out.ko img-parallel-out.ko img-spdif-in.ko img-spdif-out.ko pistachio-event-timer.ko pistachio-internal-dac.ko snd-soc-tpa6130a2.ko pistachio.ko)
